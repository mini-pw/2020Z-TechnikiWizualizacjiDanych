...
function col_left() {return svg_width()  * 0.1; }
function actual_max() {return d3.max(data, function (d) {return d.count; }); }
...
.attr('width',function(d) { return d.count * col_width(); })
...
.text(function(d) {return d.year_of_discovery; })
.style('font-family', 'sans-serif');

// Numeric labels
var totals = svg.selectAll().data(data);
totals.enter().append('text')
.attr('x', function(d) { return ((d.count * col_width()) + col_left()) * 1.01; })
.attr('y', function(d, i) { return i * col_heigth() + (col_heigth() / 2) + 1.12 * col_top(); })
.style('font-family', 'sans-serif')
