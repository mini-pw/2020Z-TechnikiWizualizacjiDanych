...
### 1. Oryginalny wykres
Pochodzi ze strony https://www.accuweather.com/pl/pl/warsaw/274663/october-weather/274663 i został otworzony w pracy Ady Gąssowskiej - plik wykres.png
...
ggplot(pogoda, aes(x=Day))+
  ...
  theme(legend.position = "bottom")+
    geom_text(mapping=aes(x=17, y=31, label="Dzisiaj"), color= "darkgrey", size=4, hjust=0.7)+
  geom_smooth(method="lm", aes(y=srednia_wys, size="srednia"), color="#CC3333")+
  geom_smooth(method="lm", aes(y=srednia_nis, size="srednia"), color="#336699")+
  ...
  xlab("")+
  ylab("Temperatura [stopnie Celsjusza]")

```

### Uzasadnienie

Dodanie pionowych i poziomych linii ułatwia orientację na wykresie