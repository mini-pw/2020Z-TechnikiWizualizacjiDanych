...
function col_left() {return svg_width() * 0.35; }
function actual_max() {return d3.max(data, function (d) {return d.median; }); }
...
bars.enter().append('rect')
  ...
  .attr('width',function(d) { return d.median * col_width(); })
...
totals.enter().append('text')
  .attr('x', function(d) { return ((d.median * col_width()) + col_left()) * 1.01; })
  .attr('y', function(d, i) { return i * col_heigth() + (col_heigth() / 2) + col_top(); })
  .style('font-family', 'sans-serif')
  .text(function(d) {return Math.round(d.median * 100)/100; });