...
dataset <- data.frame(names = rev(c("1. Makati City", "2. Quezon City",
...
fluidPage(
  ...
  sidebarPanel(
    ...
    conditionalPanel(
      ...
      sliderInput('levelOfManipulation', '... in 1-10 scale, how much?', min=0, max=10,
                  value = min(0, 10), step=1, round=0),
    ...
    selectInput('color', 'Bar color', c("brown3", "red", "blue", "black")),
