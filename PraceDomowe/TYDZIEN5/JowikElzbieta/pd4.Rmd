...
Gdybym musiała dokonywać tego typu poprawek programatywnie, problemem byłoby np. rozsunięcie słupków na odpowiednie szerokości, tak aby wprowadzenie zdjęć na lewym marginesie nie wprowadzało haosu. Ponadto, nie wiedziałabym w jaki sposób umieścić podpisy do zdjęć zawodników tuż pod nimi. Dzięki wykorzystanemu narzędziu, zabiegi te można było wykonać w sposób intuicyjny. 
